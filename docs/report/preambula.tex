...
\usepackage{titlesec}
\usepackage{setspace}
%\usepackage[showframe, left=30mm,right=10mm,top=10mm,bottom=10mm]{geometry}
\usepackage{geometry}
...
\newcommand{\appx}[1]{\chapter*{
		\LARGE\bfseries{#1}}
		\stepcounter{chapter}
	 \addcontentsline{toc}{chapter}{#1}  }
	 
\setlength{\cftaftertoctitleskip}{0pt}
\setlength{\cftchapindent}{0pt} % Отступ для глав
\setlength{\cftsecindent}{0pt}  % Отступ для разделов
