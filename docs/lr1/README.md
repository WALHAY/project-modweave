...
Repository-тесты
оставлены в классическом варианте, где несколько операций чтения после записи
проверяют сохранённое состояние базы данных.

В сервисном, вспомогательном и stub-наборе сейчас 86 unit-тестов. Вместе с 27
repository-тестами полный набор содержит 113 тестов. Монолитный
