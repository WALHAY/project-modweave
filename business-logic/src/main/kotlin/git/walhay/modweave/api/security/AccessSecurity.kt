...
class AccessSecurity(
  ...
  fun isModOwnerOrAdmin(userId: String, modId: String) =
  ...
  fun isCollectionOwnerOrAdmin(userId: String, collectionId: Long) =
  ...
  fun isCommentOwnerOrAdmin(userId: String, commentId: Long) =
