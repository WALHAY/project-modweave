...
class Game(
    @Id @Column(name = "id", nullable = false) @NotEmpty val id: String,
    @Column(name = "name", nullable = false) @NotEmpty val name: String,
    @Column(name = "description", columnDefinition = "text")
    @Nullable
    val description: String? = null,
    @Column(name = "image_path", nullable = false) @NotEmpty val imagePath: String,
